...
namespace DrawerLayout_V7_Tutorial
{
    ...
    public class MainActivity : ActionBarActivity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            mLeftDataSet.Add("Pet Home");
            mLeftDataSet.Add("Recent Activity");
            mLeftDataSet.Add("Friends");
            mLeftDataSet.Add("Data Setup");
            ...
            tx.Add(Resource.Id.main, friendsFragment);
            tx.Add(Resource.Id.main, dataFragment);

            tx.Hide(profileFragment);
            tx.Hide(friendsFragment);
            tx.Hide(dataFragment);
