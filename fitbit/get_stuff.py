...
FitbitActivityURL = "https://api.fitbit.com/1/user/-/activities/date/2016-08-07.json"
...
#Make the API call
APICallOK, APIResponse = MakeAPICall(FitbitActivityURL, AccessToken, RefreshToken)
